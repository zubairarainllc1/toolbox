...
import { handleGenerateYoutubeIdeas } from "@/app/actions";
...
export default function YoutubeIdeaGeneratorForm() {
  const [state, formAction] = useActionState(handleGenerateYoutubeIdeas, initialState);
    ...
    <Card>
      ...
      <CardContent>
        <form ref={formRef} action={formAction} className="space-y-4">
          <Input
            name="topic"
            placeholder="e.g., 'Home cooking for beginners' or 'DIY tech projects'"
            required
          />
          <SubmitButton />
        </form>
