...
import { Clipboard, Facebook, Sparkles, Check } from "lucide-react";
...
export default function FacebookHashtagGeneratorForm() {
  const [state, formAction] = useActionState(handleGenerateFacebookHashtags, initialState);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-headline text-xl flex items-center gap-2"><Facebook />Hashtag Generator</CardTitle>
        ...
        <form ref={formRef} action={formAction} className="space-y-6">
          <div className="space-y-2">
            ...
            <Input
              id="topic"
              name="topic"
              placeholder="e.g., Summer Fashion, Healthy Living"
              required
            />
          </div>
