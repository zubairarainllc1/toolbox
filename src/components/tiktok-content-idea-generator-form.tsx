...
import { handleGenerateTikTokContentIdeas } from "@/app/actions";
...
export default function TikTokContentIdeaGeneratorForm() {
  const [state, formAction] = useActionState(handleGenerateTikTokContentIdeas, initialState);
