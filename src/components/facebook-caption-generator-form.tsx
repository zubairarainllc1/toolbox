...
export default function FacebookCaptionGeneratorForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    setResult(null);
    try {
      const response = await handleGenerateFacebookCaptions({}, new FormData(form.control.fields._f.current.form));
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Summer vacation ideas, Tech news" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
