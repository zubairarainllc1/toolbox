import TikTokDescriptionGeneratorForm from "@/components/tiktok-description-generator-form";
...
export default function TikTokDescriptionGeneratorPage() {
  return (
    <>
      <div className="container mx-auto px-4 py-12 md:px-6">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="max-w-2xl text-muted-foreground md:text-lg">
            Generate engaging descriptions for your TikTok videos.
          </p>
        </div>

        <div className="mx-auto mt-12 max-w-2xl">
          <TikTokDescriptionGeneratorForm />
        </div>
      </div>
      <RelatedBlogsSection />
    </>
