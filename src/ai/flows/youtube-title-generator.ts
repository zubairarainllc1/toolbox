...
const GenerateYoutubeTitleOutputSchema = z.object({
  titles: z.array(z.string()).describe('An array of 5 generated YouTube titles.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are a YouTube viral marketing expert. Generate 5 catchy and SEO-optimized titles for a YouTube video based on the following details.
